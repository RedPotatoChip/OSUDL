...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='01_16', help='name of the experiment. It decides where to store samples and models')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='OSUDL', help='chooses which model to use.')
