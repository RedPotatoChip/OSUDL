...
class OSUDLModel(BaseModel):
    """ This class implements OSUDL model.
    This code is inspired by CUT and DCLGAN.
    """

    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        """  Configures options specific for OSUDL """
        parser.add_argument('--OSUDL_mode', type=str, default="OSUDL", choices='OSUDL')
        ...
        if opt.OSUDL_mode.lower() == "osudl":
            parser.set_defaults(nce_idt=True, lambda_NCE=2.0)
        else:
            raise ValueError(opt.OSUDL_mode)
